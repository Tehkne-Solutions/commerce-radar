...
api.savePolicy('exp-1',{maxImbalance:0,minimumDays:7,maximumDays:30,inactivityDays:5});
assert.throws(()=>api.governedApply('exp-1','champion',{product:'Produto D'}),/desequilibrada/i);
...
assert.strictEqual(counts.champion,2);
...
assert.strictEqual(snap.rows[0].champion,2);
